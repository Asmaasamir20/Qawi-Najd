            ...
            <div className="flex h-20 justify-between items-center">
              ...
              <div className="hidden md:flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-black text-sm tracking-wide">+89(0) 1256 2156</span>
                </div>
                {/* Request a quote */}
                <Link
                  to="/quote"
                  className={`flex items-center border border-black rounded-full px-3 py-1 bg-white hover:bg-gray-50 transition group ${lang === 'ar' ? 'flex-row-reverse' : ''}`}
                >
                  <span className={`font-medium text-black text-sm ${lang === 'ar' ? 'mr-2' : 'mr-2'}`}>{t('request_quote')}</span>
          ...
          <Disclosure.Panel className="md:hidden bg-[#f5f9f9]">
            <div className="flex flex-col gap-1.5 px-4 pt-3 pb-2">
              ...
              <div className="flex flex-col gap-2 mt-3">
                ...
                <Link
                  to="/quote"
                  className={`flex items-center justify-between border border-black rounded-full px-3 py-1.5 bg-white hover:bg-gray-50 transition group w-full text-sm font-bold ${lang === 'ar' ? 'flex-row-reverse' : ''}`}
                >
