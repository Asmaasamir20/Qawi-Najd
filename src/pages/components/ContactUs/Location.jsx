...
const Location = () => {
  ...
  const locations = {
    alkharj: {
      id: 'alkharj',
      name: 'مكتب الخرج',
      address: 'الخرج، المملكة العربية السعودية',
    ...
    mulham: {
      id: 'mulham',
      name: 'مكتب ملهم',
      address: 'ملهم، المملكة العربية السعودية',
      phones: ['+966 54 824 0556', '+966 55 777 0557'],
    ...
    alaqiq: {
      id: 'alaqiq',
      name: 'مكتب الباحة العقيق',
      address: 'العقيق، المملكة العربية السعودية',
      phones: ['+966 54 824 0556', '+966 55 777 0557'],
      coordinates: [25.164806377731757, 46.324943575380686],
      mapUrl:
    ...
    albaha: {
      ...
      phones: ['+966 54 824 0556', '+966 55 777 0557'],
      coordinates: [19.8617082, 41.5586088],
      mapUrl:
        'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3752.485568616483!2d41.558608799999995!3d19.8617082!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15ef5d16ac9ee875%3A0xc769f6a3c8d3f8cb!2z2YXZg9iq2Kgg2LPYudivINmF2LPZgdixINii2YQg2YfYtNio2YjZhCDZhNmE2KfYs9iq2LTYp9ix2KfYqiDYp9mE2YfZhtiv2LPZitip!5e0!3m2!1sen!2seg!4v1747850491925!5m2!1sen!2seg',
    },
  };
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600'>
            نحن موجودون في عدة مواقع استراتيجية في المملكة العربية السعودية
          </p>
        </div>
          ...
          <div className='bg-white rounded-lg shadow-md p-6'>
            ...
            <div className='space-y-6'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  <h4 className='text-base font-medium text-gray-900 mb-1'>العنوان</h4>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  <h4 className='text-base font-medium text-gray-900 mb-2'>أرقام الجوال</h4>
